...
export default function FallbackCard({
  ...
  return (
    <div
      className={`relative flex flex-col items-center justify-center h-[320px] w-full overflow-hidden rounded-2xl border border-border/40 shadow-lg ${baseBg} ${className}`}
    >
      {showGlitch && (
      ...
      <div
        ...
        style={{
          background:
            theme === "dark"
              ? "radial-gradient(ellipse 80% 60% at 50% 50%, rgba(0, 204, 204, 0.15), transparent 70%), #000000"
